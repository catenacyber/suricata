...
.. container:: example-rule
  ...
  alert ip any any -> any any (msg:"Test LDAPDN and operation"; :example-rule-emphasis:`ldap.request.operation:search_request; ldap.request.distinguished_name:dc=example,dc=com;` sid:1;)
...
``ldap.responses.dn`` is a 'sticky buffer'.
...
.. container:: example-rule
  ...
  alert ip any any -> any any (msg:"Test LDAPDN"; :example-rule-emphasis:`ldap.responses.dn:dc=example,dc=com;` sid:1;)
...
.. container:: example-rule
  ...
  alert ip any any -> any any (msg:"Test LDAPDN and operation"; :example-rule-emphasis:`ldap.responses.operation:search_result_entry; ldap.responses.dn:dc=example,dc=com;` sid:1;)