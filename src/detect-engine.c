 ...
 *
 *  \note errors are fatal */
void DetectAppLayerInspectEngineRegisterAux(const char *name, AppProto alproto, uint32_t dir,
...
void DetectAppLayerInspectEngineRegister(const char *name, AppProto alproto, uint32_t dir,
        int progress, InspectEngineFuncPtr Callback, InspectionBufferGetDataPtr GetData)
{
    DetectAppLayerInspectEngineRegisterAux(name, alproto, dir, progress, Callback, GetData, NULL);
}
...
{
    DetectAppLayerInspectEngineRegisterAux(
