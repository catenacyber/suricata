...
static bool DetectFTPCommandDataGetData(DetectEngineThreadCtx *det_ctx, const void *txv,
        const uint8_t _flow_flags, const uint8_t **buffer, uint32_t *buffer_len)
{
...
void DetectFtpCommandDataRegister(void)
{
    ...
    DetectHelperBufferMpmRegister(
            BUFFER_NAME, BUFFER_NAME, ALPROTO_FTP, STREAM_TOSERVER, DetectFTPCommandDataGetData);
