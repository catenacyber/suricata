        ...
        const uint8_t **data, uint32_t *data_len)
{
    ...
    if (ssl_state->client_connp.ja3_str == NULL || ssl_state->client_connp.ja3_str->data == NULL) {
        return false;
    }

    *data_len = strlen(ssl_state->client_connp.ja3_str->data);
    *data = (uint8_t *)ssl_state->client_connp.ja3_str->data;
    return true;
}
#endif
